...
/*   Updated: 2025/02/10 17:37:41 by joaomigu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * This function builds the left part of the prompt using the given user and local host.
 ...
 *
 * This function identifies whether the session manager contains a "local/" or "unix/" prefix.
 * It sets the start pointer to the appropriate location and updates the start length accordingly.
 *
