...
SRCS =	${SRC_DIR}/main.c 							${SRC_DIR}/aux.c 						${SRC_DIR}/common.c								\
		...
		${SRC_DIR}/builtins/export/export_print.c 	${SRC_DIR}/builtins/export/export.c 													\
		${SRC_DIR}/executor/executor_aux_safe.c 	${SRC_DIR}/executor/executor_aux.c 		${SRC_DIR}/executor/executor_child_aux.c 		\
		${SRC_DIR}/executor/executor_child.c 		${SRC_DIR}/executor/executor_common.c 	${SRC_DIR}/executor/executor_free.c				\
		${SRC_DIR}/executor/executor_heredoc.c 		${SRC_DIR}/executor/executor_isolated.c ${SRC_DIR}/executor/executor_redir.c 			\
		${SRC_DIR}/executor/executor.c 				${SRC_DIR}/executor/mock_parser.c  		${SRC_DIR}/executor/mock_parser_tests.c 		\
